...
## BUG4. Негативное тестирование. Получение качественной информации при отправке GET-запроса
...
## BUG5. Позитивное тестирование. Получение некачественной  по объявлениям продавца при отправке GET-запроса
