...
func (suite *AdsAPITestSuiteV1) TestGetStatisticsByIDSuccess() {
...
func (suite *AdsAPITestSuiteV1) TestGetAStatisticsByIDNotFound() {
...
func (suite *AdsAPITestSuiteV1) TestGetStatisticsByIDInvalidFormat() {
    testCases := []struct {
        name string
        id   string
    }{
